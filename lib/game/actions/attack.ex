defmodule ExMon.Game.Actions.Attack do
  ...
  @move_avg_power 18..25 # uso os .. para criar uma lista, intervalo de dados
  ...
  defp update_opponent_life(life, opponent, damage) do #pega um player e muda vida do oponente
    opponent
    |> Game.fetch_player()
    |> Map.put(:life, life)
  ...
  defp update_game(player, opponent, damage) do #Pega as infos de um dos jogadores muda para o novo valor da vida
    Game.info()
